...
With the additional hypothesis that symex is \emph{exact} (biconditional with $H_\mathcal{I}.\text{step}$, adding $h_\text{symex\_complete}$), we obtain bisimulation among reachable states: both $G' \preceq H_\mathcal{I}$ and $H_\mathcal{I} \preceq G'$ hold with witness relations restricted to $\text{Reach}(H_\mathcal{I})$.}

\textcolor{red}{\textbf{Why a separate construction is needed.}
...
\textcolor{red}{\textbf{The bisimulation construction.}
