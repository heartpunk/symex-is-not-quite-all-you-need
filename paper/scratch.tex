...
\textcolor{red}{\textbf{On grammar conformance.} Grammar conformance (\texttt{GrammarConformant}) is a precondition of the theorem, not something the proof constructs. The grammar structure is discovered by testing---grammar mining, template enumeration, or provided as a known specification. The theorem is conditional on this structure being correctly identified.}
