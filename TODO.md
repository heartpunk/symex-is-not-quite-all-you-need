...
- [ ] **Docstring line references to scratch.tex are brittle.** E.g., "line 230, line 323" in CoRefinementConvergence.lean:98-99 — both numbers are stale after paper edits. Reference theorem names instead. (CoRefinementConvergence.lean)
